...
//     重新生成代码，这些更改将会丢失。
//		如存在本生成代码外的新需求，请在相同命名空间下创建同名分部类实现 CategoryConfigurationAppend 分部方法。
// </auto-generated>
//
// <copyright file="CategoryConfiguration.generated.cs">
...
namespace MrHai.Core.Data.Configurations
{
    ...
    /// 实体类-数据表映射——菜单
    /// </summary>    
	internal partial class CategoryConfiguration : EntityTypeConfiguration<Category>, IEntityMapper
    {
        /// <summary>
        /// 实体类-数据表映射构造函数——菜单
        /// </summary>
