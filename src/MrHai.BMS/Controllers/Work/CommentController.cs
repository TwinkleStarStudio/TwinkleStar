...
namespace MrHai.BMS.Controllers.Work
{
    ...
    public class CommentController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            var list = MrHaiApplication.CommonSearch(workName, caID, InfomationType.Comments, ref count, pageIndex, pageSize).AppendData as List<InfomationDto> ?? new List<InfomationDto>();
        ...
        public ActionResult Add()
        {
            ...
            if (string.IsNullOrEmpty(data.infoID))//新增
            {
                ...
                data.infoType = InfomationType.Comments;
                data.userID = UserID;
